...
class account_invoice(osv.osv):
	...
	cr.execute("""
		create or replace view account_state_report as (
				select a.id,a.company_id as company_id,a.period_id as period_id,a.journal_id as journal_id,b.state_id as state_id,sum(a.amount_total) as amount_total, 
